    ...
    topics: [
      {
        ...
        masteryPack: {
          ...
          primaryText: {
            ...
            url: 'https://openstax.org/books/college-algebra-2e/pages/1-introduction',
            pdfUrl: 'https://d3bxy9euw4e147.cloudfront.net/oscms-prodcms/media/documents/CollegeAlgebra2e-WEB.pdf',
          ...
          authoritativeResearchSource: {
            ...
            openAccessUrl: 'https://www.cs.sfu.ca/~ggbaker/zju/math/asymptotic.pdf',
            paperType: 'seminal',
    ...
    topics: [
      {
        ...
        masteryPack: {
          ...
          primaryText: {
            ...
            pdfUrl: 'https://math.mit.edu/~gs/linearalgebra/ila6_preview.pdf',
          ...
          authoritativeResearchSource: {
            ...
            openAccessUrl: 'https://ilpubs.stanford.edu:8090/422/1/1999-66.pdf',
            paperType: 'applied',
            difficulty: 'intermediate',
