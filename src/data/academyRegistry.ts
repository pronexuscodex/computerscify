...
export const LEARNING_PATHS: LearningPath[] = [
  ...
  path({ id: 'data-engineer', slug: 'data-engineer', title: 'Data Engineer', description: 'Design databases, transformations, and production data platforms.', academyId: 'data-engineering', level: level('intermediate'), estimatedHours: 388, careerOutcomes: ['Data engineer', 'Analytics engineer'], courses: [['cs-102', 'ds-101'], ['ds-202', 'ds-303', 'de-100'], ['ds-401']], competencies: [['programming-fluency'], ['data-systems', 'delivery-automation'], ['portfolio-communication']] }),
